...
<form action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
  ...
  <div class="actions row">  
  	...
  	<div class="coupon">
  		<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Coupon code', 'woocommerce' ); ?>" /> <input type="submit" class="btn btn-default btn-sm" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
  	...
  	<div class="pull-right">
    	...
    	<input type="submit" class="checkout-button btn btn-success alt wc-forward" name="proceed" value="<?php _e( 'Proceed to Checkout', 'woocommerce' ); ?>" />
  	</div>
